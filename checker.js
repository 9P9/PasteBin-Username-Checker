...
function pcheck(username,type) {
    ...
    request({
        ...
        process.title = `[313][Pastebin Usernames Checker] - ${checked}/${usernames.length} Total Checked | ${available} Available | ${unavailable} Unavailable | ${rate} Rate Limited`;
    });
}
...
function printAsciiLogo() {
  console.log(chalk.inverse.hex("66ff00")`
		▄▄▄· ▄▄▄· .▄▄ · ▄▄▄▄▄▄▄▄ .▄▄▄▄· ▪   ▐ ▄    ▄▄·  ▄ .▄▄▄▄ . ▄▄· ▄ •▄ ▄▄▄ .▄▄▄  
		▐█ ▄█▐█ ▀█ ▐█ ▀. •██  ▀▄.▀·▐█ ▀█▪██ •█▌▐█  ▐█ ▌▪██▪▐█▀▄.▀·▐█ ▌▪█▌▄▌▪▀▄.▀·▀▄ █·
		██▀·▄█▀▀█ ▄▀▀▀█▄ ▐█.▪▐▀▀▪▄▐█▀▀█▄▐█·▐█▐▐▌  ██ ▄▄██▀▐█▐▀▀▪▄██ ▄▄▐▀▀▄·▐▀▀▪▄▐▀▀▄ 
		▐█▪·•▐█ ▪▐▌▐█▄▪▐█ ▐█▌·▐█▄▄▌██▄▪▐█▐█▌██▐█▌  ▐███▌██▌▐▀▐█▄▄▌▐███▌▐█.█▌▐█▄▄▌▐█•█▌
...
printAsciiLogo();
process.title = `[313][Pastebin Usernames Checker] Created By Luci`;
...
[3] socks5`); 
			...
			console.log(`[Pastebin Username Checker]: Started!`.inverse);
